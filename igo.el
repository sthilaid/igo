...
(defun igo-draw-game-info (gamestate)
  (let ((game-info (igo-state-get-game-info gamestate)))
    (insert (concat "variation-style: "(igo-info-get-variation-style game-info))) (newline)
    (insert (concat "board-size: "(igo-info-get-board-size game-info))) (newline)
    (insert (concat "annotator-name: "(igo-info-get-annotator-name game-info))) (newline)
    (insert (concat "copyright: "(igo-info-get-copyright game-info))) (newline)
    (insert (concat "date: "(igo-info-get-date game-info))) (newline)
    (insert (concat "event: "(igo-info-get-event game-info))) (newline)
    (insert (concat "game-name: "(igo-info-get-game-name game-info))) (newline)
    (insert (concat "black-player-name: "(igo-info-get-black-player-name game-info))) (newline)
    (insert (concat "black-rank: "(igo-info-get-black-rank game-info))) (newline)
    (insert (concat "black-team: "(igo-info-get-black-team game-info))) (newline)
    (insert (concat "white-player-name: "(igo-info-get-white-player-name game-info))) (newline)
    (insert (concat "white-rank: "(igo-info-get-white-rank game-info))) (newline)
    (insert (concat "white-team: "(igo-info-get-white-team game-info))) (newline)
    (insert (concat "opening-info: "(igo-info-get-opening-info game-info))) (newline)
    (insert (concat "overtime-type: "(igo-info-get-overtime-type game-info))) (newline)
    (insert (concat "game-place: "(igo-info-get-game-place game-info))) (newline)
    (insert (concat "result: "(igo-info-get-result game-info))) (newline)
    (insert (concat "game-round-info: "(igo-info-get-game-round-info game-info))) (newline)
    (insert (concat "game-rules: "(igo-info-get-game-rules game-info))) (newline)
    (insert (concat "game-source: "(igo-info-get-game-source game-info))) (newline)
    (insert (concat "time-limit: "(igo-info-get-time-limit game-info))) (newline)
    (insert (concat "game-scribe-user: "(igo-info-get-game-scribe-user game-info))) (newline)
    (insert (concat "game-handicap: " (number-to-string (igo-info-get-game-handicap game-info)))) (newline)
    (insert (concat "game-komi: " (number-to-string (igo-info-get-game-komi game-info)))) (newline)
    (insert (concat "game-comment: "(igo-info-get-game-comment game-info))) (newline)
    ))
